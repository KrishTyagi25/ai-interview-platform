...
function Landing() {
  return (
    <div className="... cursor-pointer transition-all duration-300 min-h-screen bg-darkbg text-white relative overflow-hidden"
    >
      <AnimatedBackground />
      <Navbar />
...
<div className="flex flex-col items-center justify-center text-center px-6 pt-40 min-h-[80vh]">
        <motion.h1
          ...
          className="text-4xl md:text-6xl leading-tight tracking-tight font-extrabold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent"
        >
